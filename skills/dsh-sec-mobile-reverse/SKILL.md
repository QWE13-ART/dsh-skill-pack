---
name: dsh-sec-mobile-reverse
version: 1.0.0
description: 移动端逆向（安卓/iOS、APK/IPA 分析、SSL 抓包）。Use for authorized Android or iOS application reverse engineering and security testing, including APK or IPA analysis, runtime instrumentation, SSL pinning, and platform protection checks.
---
