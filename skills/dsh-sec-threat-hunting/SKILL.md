---
name: dsh-sec-threat-hunting
version: 1.0.0
description: 威胁狩猎（检测规则、Sigma/YARA、SIEM 查询、蓝队）。Use for blue-team threat hunting, detection engineering with Sigma/YARA, SIEM query design, and incident detection validation.
---
