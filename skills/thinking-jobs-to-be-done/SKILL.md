...
version: 1.0.0
description: 待办任务 JTBD（用户要完成什么、为何选择、替代方案）。Deciding what to build or why adoption fails. Recover the progress users hire a solution for under a circumstance, then rank by outcome and competing workarounds.
---
