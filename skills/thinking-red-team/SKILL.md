...
version: 1.0.0
description: 红队（攻击视角审查、找漏洞、可复现利用）。For authorized security review of code, auth, or APIs you control, model the attacker, map the attack surface, and report only findings with a reproducible exploit path and verified mitigation.
---
