...
version: 1.0.0
description: 二阶效应（连锁后果、激励、时机）。When a change has effects past the immediate fix—incentives, scale, feedback—trace consequence chains with timing and probability before committing.
---
