---
name: dsh-sec-cloud-k8s
version: 1.0.0
description: 云安全与 K8s 安全（容器逃逸、IAM 配置错误、SSRF、集群权限）。Use for authorized cloud, container, and Kubernetes security assessment including metadata SSRF, IAM misconfig, container escape paths, and cluster RBAC review.
---
