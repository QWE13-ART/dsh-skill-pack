---
name: dsh-sec-thick-client
version: 1.0.0
description: 厚客户端安全（桌面应用、本地存储、IPC、流量、更新通道）。Use for authorized security testing of desktop thick clients including local storage, update channels, IPC, traffic, and client-side trust boundaries.
---
