---
version: 1.0.0
name: dsh-observability-and-instrumentation
description: 可观测性与埋点。加日志/指标/追踪/告警、上线生产功能需证据、生产问题无数据可查时使用。 Observability and instrumentation. Use when adding logs, metrics, tracing, or alerts; launching production features that need evidence; or when production issues have no data to investigate.
---
