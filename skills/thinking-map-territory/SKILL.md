...
version: 1.0.0
description: 地图与领土（文档 vs 实际、以实测为准）。When a claim, doc, test, metric, or assumption conflicts with observed behavior, stop theorizing from the map and verify the live code or data; let territory overrule.
---
