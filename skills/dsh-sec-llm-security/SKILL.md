---
name: dsh-sec-llm-security
version: 1.0.0
description: LLM 安全（提示注入、工具滥用、RAG 安全、模型供应链）。Use for authorized security assessment of LLM applications and AI agents, including prompt injection, tool abuse, RAG exposure, memory poisoning, and model supply-chain risks.
---
# LLM / AI 安全测试
