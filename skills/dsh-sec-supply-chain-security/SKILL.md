---
name: dsh-sec-supply-chain-security
version: 1.0.0
description: 供应链安全（SBOM、依赖投毒、CI/CD 安全、构建完整性）。Use for software supply-chain security assessment covering SBOM, SCA, CI/CD pipelines, container images, build integrity, dependency provenance, and vulnerability reachability.
---
