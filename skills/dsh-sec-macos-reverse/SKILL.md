---
name: dsh-sec-macos-reverse
version: 1.0.0
description: macOS 逆向（Mach-O、Objective-C/Swift 恢复、代码签名）。Use for authorized macOS and Mach-O reverse engineering including codesign, Objective-C/Swift recovery, endpoint security surfaces, and Apple platform malware analysis.
---
