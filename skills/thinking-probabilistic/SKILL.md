...
version: 1.0.0
description: 概率思维（贝叶斯、基准率、区间估计）。Use when forecasting, estimating, or sizing risk — anchor on base rates, give ranges, update prior→likelihood→posterior on evidence, and factor unmeasured quantities into order-of-magnitude bounds.
---
