...
version: 1.0.0
description: 模型组合（多视角互补、命名角色、冲突规则）。When one mental model leaves a material blind spot on a multi-domain or high-stakes problem, sequence complementary models with named roles and a conflict rule.
---
