...
version: 1.0.0
description: 反向排除法（做减法、删除而非添加）。Use when the reflex is to add a feature, layer, or process. Prefer removing harmful or nonessential elements first, with an irreversibility guard before deletion.
---
