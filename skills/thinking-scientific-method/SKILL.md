...
version: 1.0.0
description: 科学方法（假设可证伪、最小判别实验）。When a symptom has several plausible causes, rank falsifiable hypotheses and run the cheapest discriminating observation first; prefer least-assumptive survivors only after evidence fit.
---
