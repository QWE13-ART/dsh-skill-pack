---
name: dsh-sec-windows-ad
version: 1.0.0
description: Windows AD 安全（域渗透、Kerberos、AD CS、NTLM、BloodHound）。Use for authorized Active Directory and Windows identity attacks including Kerberos, AD CS, BloodHound paths, NTLM relay, and domain privilege escalation research.
---
