...
version: 1.0.0
description: 机会成本（放弃的次优选择、价值差）。Before committing scarce time, people, or money, name the best forgone use of those resources and the value delta of the chosen path versus that alternative.
---
