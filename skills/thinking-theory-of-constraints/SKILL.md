...
version: 1.0.0
description: 约束理论（找瓶颈、吞吐量限制）。When throughput or latency is pipeline-limited, identify the single binding constraint and exploit, subordinate, elevate, then recheck—ignore non-constraints.
---
