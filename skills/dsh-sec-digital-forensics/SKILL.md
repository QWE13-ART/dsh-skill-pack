---
name: dsh-sec-digital-forensics
version: 1.0.0
description: 数字取证（内存取证、磁盘时间线、PCAP 分析、应急响应取证）。Use for authorized digital forensics including memory dumps, disk timelines, PCAP investigation, artifact triage, and IR evidence preservation.
---
