---
name: dsh-sec-browser-extension-reverse
version: 1.0.0
description: 浏览器扩展逆向（Chrome/Firefox 插件分析、扩展凭证与流量逻辑恢复）。Use for authorized reverse engineering of browser extensions (Chrome/Firefox) including manifest analysis, background workers, and extension-based credential or traffic logic recovery.
---
