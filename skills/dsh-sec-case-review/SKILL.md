---
name: dsh-sec-case-review
version: 1.0.0
description: 逆向案例包审查（证据链核验、报告交付前检查）。Reviews a reverse-skill case package for scope readiness, Evidence to Finding to Path traceability, work item coverage, timeline references, and optional artifact hash integrity before report handoff.
---
