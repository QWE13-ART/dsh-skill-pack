...
version: 1.0.0
description: 苏格拉底式提问（追问澄清、暴露隐藏假设）。When a request is vague, assumption-laden, or "obvious," ask the few load-bearing questions that expose hidden requirements before building or committing.
---
