---
version: 1.0.0
name: dsh-source-driven-development
description: 官方文档验证驱动开发。构建任何框架/库代码、追求权威来源与正确性时使用；每个实现决策都锚定官方文档，防幻觉、防过时模式。 Source-driven development (official documentation verified). Use when building any framework or library code, pursuing authoritative sources and correctness; every implementation decision is anchored to official docs, preventing hallucination and outdated patterns.
---
