...
name: thinking-triz
version: 1.0.0
description: TRIZ 创新法（矛盾、分离条件、无妥协解决）。When two design requirements seem mutually exclusive, name the contradiction, separate conflicting states, then invent a concrete no-compromise resolution.
---
