...
version: 1.0.0
description: 能力圈（证据边界、不知道就承认、不编造）。Use when a specific claim may lack grounding. Check evidence boundary, size wrongness cost, then answer, fetch, or abstain — never confabulate.
---
