---
name: dsh-sec-code-audit
version: 1.0.0
description: 代码安全审计（源码审计、SAST、Semgrep、CodeQL、漏洞挖掘、危险 API）。Use for authorized source-code security review and SAST workflows including Semgrep, CodeQL patterns, dangerous API hunting, and fix verification.
---
