---
version: 1.0.0
name: dsh-shipping-and-launch
description: 发布与上线。准备部署生产、需要上线前清单、监控搭建、分阶段灰度、回滚策略时使用。 Shipping and launch. Use when preparing for production deployment, need pre-launch checklists, monitoring setup, phased rollouts, and rollback strategies.
---
