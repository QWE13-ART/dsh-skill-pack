---
name: dsh-sec-wifi-wireless
version: 1.0.0
description: 无线安全 WiFi（WPA 握手破解、Rogue AP、抓包、deauth）。Use for authorized wireless security assessment including Wi-Fi capture, WPA handshake analysis, rogue AP detection research, and lab-only deauth testing.
---
