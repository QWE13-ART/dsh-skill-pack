...
version: 1.0.0
description: 林迪效应（长寿事物、存续时间越久越可靠）。Use when longevity of a non-perishable option matters. Treat survival duration as a remaining-life prior, then check domain drift before favoring the proven.
---
