---
name: dsh-sec-threat-intelligence
version: 1.0.0
description: 威胁情报（OSINT、IOC、黑产情报、安全情报）。Use for authorized OSINT and cyber threat intelligence that enriches IOCs, campaigns, impersonation, scams, or threat actors from public sources. Includes bounded X/Twitter search through Xquik, source preservation, corroboration, and evidence handoff.
---
