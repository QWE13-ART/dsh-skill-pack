---
name: dsh-sec-radio-sdr
version: 1.0.0
description: 无线电 SDR 安全研究（信号识别、射频分析、无线协议）。Use for authorized RF/SDR security research including signal identification, replay feasibility study in shielded labs, and wireless protocol analysis outside classic Wi-Fi.
---
