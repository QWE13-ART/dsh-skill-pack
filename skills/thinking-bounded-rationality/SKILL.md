...
version: 1.0.0
description: 有限理性（搜索止损、设定足够好阈值就停）。Use when search or investigation could run forever. Set an explicit good-enough threshold first, then stop at the first option that clears it.
---
