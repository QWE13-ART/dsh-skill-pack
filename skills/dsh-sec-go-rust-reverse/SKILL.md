---
name: dsh-sec-go-rust-reverse
version: 1.0.0
description: Go/Rust 二进制逆向（去符号二进制、pclntab 恢复、运行时识别）。Use for reverse engineering stripped Go and Rust binaries including runtime recognition, pclntab/moduel data recovery, panic strings, and idiomatic decompilation recovery.
---
