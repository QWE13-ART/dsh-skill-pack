...
version: 1.0.0
description: 钢人论证（构造最强反方、先立后破）。Before rejecting a proposal or reflexively agreeing, build the strongest faithful opposing case, state agreement conditions, then update or reaffirm.
---
