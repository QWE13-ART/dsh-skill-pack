---
name: dsh-sec-identity-federation
version: 1.0.0
description: 身份联邦安全（SAML/OIDC/OAuth2/SSO、令牌混淆）。Use for authorized assessment of federated identity systems including SAML, OIDC, OAuth2 flows, SSO misconfiguration, and token confusion issues.
---
