---
name: dsh-sec-hardware-security
version: 1.0.0
description: 硬件安全（UART/JTAG 接口、固件提取、嵌入式安全）。Use for authorized hardware and embedded interface security research including UART/JTAG discovery, debug pad triage, secure boot overview, and offline firmware extraction support.
---
