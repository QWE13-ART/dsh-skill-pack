...
version: 1.0.0
description: 五问法（根因分析、连续追问、反事实检验）。When a fault is localized and the proximate cause is known but the systemic root is not, chain evidence-linked whys with a counterfactual stop and a countermeasure.
---
