...
name: thinking-ooda
version: 1.0.0
description: OODA 循环（观察-判断-决策-行动、七成把握就动）。Use under time pressure when the situation is still changing and you must act before certainty — cycle Observe→Orient→Decide→Act on ~70% confidence, then re-observe.
---
