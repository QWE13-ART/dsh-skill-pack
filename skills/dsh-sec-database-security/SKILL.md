---
name: dsh-sec-database-security
version: 1.0.0
description: 数据库安全评估（数据库暴露面、Redis/Mongo/MySQL、认证、UDF 命令执行）。Use for authorized database security assessment covering PostgreSQL/MySQL/MSSQL/Mongo/Redis exposure, authz, UDF/command paths, and misconfiguration review.
---
