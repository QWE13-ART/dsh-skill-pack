...
version: 1.0.0
description: 可逆性（两扇门快速决策、单向门慎重）。Before heavy deliberation, classify the decision as cheap or costly to undo; decide two-way doors fast and stage one-way doors to preserve options.
---
