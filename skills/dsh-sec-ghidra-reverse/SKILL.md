---
name: dsh-sec-ghidra-reverse
version: 1.0.0
description: Ghidra 逆向（反编译、交叉引用、免费逆向工具）。Use for free/open reverse engineering with Ghidra (headless or GUI), including decompile, cross-refs, and optional Ghidra MCP workflows when IDA is unavailable.
---
