...
version: 1.0.0
description: 安全边际（预留缓冲、容错、上限）。When provisioning, setting a limit, or committing an estimate under uncertainty, size a buffer to residual error and the cost of breach—not to the optimistic edge.
---
