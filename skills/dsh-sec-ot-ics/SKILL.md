...
name: dsh-sec-ot-ics
version: 1.0.0
description: 工控安全 OT/ICS（PLC/SCADA、工业协议、普渡模型）。Use for authorized OT/ICS security assessment covering Purdue model zoning, PLC/SCADA exposure, industrial protocol discovery, and safe passive-first evaluation.
---
