---
name: dsh-sec-api-security
version: 1.0.0
description: API 安全测试（接口安全评估、REST/GraphQL/WebSocket 漏洞、鉴权绕过）。Use for authorized security assessment of REST, GraphQL, WebSocket, or SOAP APIs, including discovery, authentication, authorization, rate-limit, and CI/CD testing.
---
# API 安全测试
