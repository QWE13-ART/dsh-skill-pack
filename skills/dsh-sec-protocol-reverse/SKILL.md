---
name: dsh-sec-protocol-reverse
version: 1.0.0
description: 协议逆向（自定义协议、Protobuf/gRPC、WebSocket 帧）。Use for authorized reverse engineering of custom binary protocols, Protobuf/gRPC, WebSocket frames, and PCAP-driven protocol recovery.
---
