---
name: dsh-sec-email-security
version: 1.0.0
description: 邮件安全分析（钓鱼邮件、SPF/DKIM/DMARC、BEC 欺诈）。Use for authorized email security review including phishing analysis, header authentication (SPF/DKIM/DMARC), BEC patterns, and mailbox token abuse research.
---
